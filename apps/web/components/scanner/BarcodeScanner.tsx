        ...
        <div className="relative h-full w-full">
            ...
            {status === "scanning" && hasTorch && (
                <button
                    onClick={toggleTorch}
                    type="button"
                    className="absolute top-4 end-4 z-40 flex h-10 w-10 items-center justify-center rounded-full border border-white/20 bg-black/60 text-white backdrop-blur-md transition-all duration-300 hover:scale-105 hover:bg-black/85 active:scale-95"
