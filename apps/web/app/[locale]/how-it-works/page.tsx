            ...
            <section className="relative px-6 pt-24 pb-20">
                ...
                <div className="relative mx-auto max-w-6xl text-center">
                    <Link
                        ...
                        className="absolute top-6 start-6 flex h-12 w-12 items-center justify-center rounded-full border border-(--color-border-muted) bg-(--color-surface-muted) shadow-sm transition-all duration-300 hover:scale-105 hover:bg-(--color-border-muted)"
                    >
