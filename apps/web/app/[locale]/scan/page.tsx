            ...
            <div className="flex flex-col items-center space-y-4 text-center">
                ...
                {medicine.cdsco_approval_status === "approved" && (
                    <div className="flex w-full items-start gap-3 rounded-2xl border border-emerald-250 dark:border-emerald-900 bg-emerald-50 dark:bg-emerald-950/20 p-4 text-start">
                        <Info
                            size={18}
                            className="mt-0.5 shrink-0 text-emerald-600 dark:text-emerald-450"
                        />
        ...
        <div className="relative flex min-h-screen flex-col overflow-x-clip bg-black font-sans text-white">
            ...
            <div className="relative flex flex-1 items-center justify-center">
                ...
                <div className="relative z-10 h-72 w-72 md:h-96 md:w-96">
                    <div className="absolute top-0 start-0 h-12 w-12 animate-pulse rounded-ss-2xl border-t-4 border-s-4 border-emerald-500 shadow-[0_0_12px_rgba(16,185,129,0.3)]"></div>
                    <div className="absolute top-0 end-0 h-12 w-12 animate-pulse rounded-se-2xl border-t-4 border-e-4 border-emerald-500 shadow-[0_0_12px_rgba(16,185,129,0.3)]"></div>
                    <div className="absolute bottom-0 start-0 h-12 w-12 animate-pulse rounded-es-2xl border-b-4 border-s-4 border-emerald-500 shadow-[0_0_12px_rgba(16,185,129,0.3)]"></div>
                    <div className="absolute end-0 bottom-0 h-12 w-12 animate-pulse rounded-ee-2xl border-e-4 border-b-4 border-emerald-500 shadow-[0_0_12px_rgba(16,185,129,0.3)]"></div>
