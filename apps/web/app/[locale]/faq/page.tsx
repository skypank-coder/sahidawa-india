                ...
                <div className="space-y-4">
                    {faqs.map((faq, i) => (
                        ...
                        >
                            <button
                                onClick={() => toggle(i)}
                                className="w-full flex items-center justify-between px-6 py-5 text-start transition-colors duration-200 hover:bg-emerald-500/[0.01]"
                            >
                                ...
                                <div className="shrink-0 ms-4 text-(--color-text-muted)">
